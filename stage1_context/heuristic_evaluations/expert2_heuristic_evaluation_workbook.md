...
| **Issue**       | **Severity** | Recommendation |
| --------------- | ------------ | -------------- |
| Faltam botões que facilitem a ações mais comuns para o utilizador, 
como ativar modo escuro, um botão para voltar ao topo, trocar de episodios, etc. | 4            |                |
|    |             |                |
...
| **Issue**       | **Severity** | Recommendation |
| --------------- | ------------ | -------------- |
| Não há opção para baixar para ver depois | 4            |                |
|    |             |                |
